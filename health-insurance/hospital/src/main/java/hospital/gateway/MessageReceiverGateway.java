...
public class MessageReceiverGateway {
    ...
    /**
     * Method establishes connection to ActiveMQ and sets destination
     * @param channelName method requests channel name for initialization
     */
     ...
     * @param ml requests message listener
     */
